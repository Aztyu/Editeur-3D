...
LDLIBSOPTIONS=-lcomdlg32 -lIrrlicht libraries/tinyxml/tinyxml.a
...
${OBJECTDIR}/GraphicalInterface.o: GraphicalInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphicalInterface.o GraphicalInterface.cpp

${OBJECTDIR}/GroupObject.o: GroupObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GroupObject.o GroupObject.cpp
...
${OBJECTDIR}/SingleObject.o: SingleObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SingleObject.o SingleObject.cpp

${OBJECTDIR}/Zone.o: Zone.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Zone.o Zone.cpp

${OBJECTDIR}/editor.o: editor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/editor.o editor.cpp
